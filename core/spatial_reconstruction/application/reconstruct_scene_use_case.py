...
Bounded context: Spatial Reconstruction.
...
Cross-context note:
  This use case accepts an optional list[TelemetryRecord] from the Telemetry
  Ingestion bounded context (Conformist pattern — see i_spatial_reconstruction_ports.py).
  TelemetryRecord is passed through unchanged to SfMMapperPort. This use case does not
  interpret, validate, or transform Telemetry data — it is purely a pass-through.
"""
from core.spatial_reconstruction.domain.model import InferenceContract, SplatScene
